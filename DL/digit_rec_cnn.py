...
def conv2d(x,W):
	return tf.nn.conv2d(x,W,strides=[1,1,1,1],padding='SAME') #Computes a 2-D convolution given 2-D 'input' and 'filter' tensors
...
def main():
	...
	#y = tf.matmul(x,W) + b #matmu means matrix multiplication
	...
	print "test accuracy %g" % accuracy.eval(feed_dict={x: mnist.test.imgaes, y_:mnist.test.labels, keep_prob:1.0})
